 ...
 */
final class Version20240325210925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `admin` ADD id_utilisateur_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `admin` DROP id_utilisateur_id');
    }
}
